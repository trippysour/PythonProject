...
from PySide2.QtWidgets import QListWidgetItem, QListWidget, QWidget, QGroupBox, QTabWidget, QCheckBox, QMessageBox, \
    QHBoxLayout, QVBoxLayout, QTableWidget, QLineEdit, QPushButton, QApplication, QTableWidgetItem, QFileDialog, \
    QAbstractItemView
